...
<head>
    ...
    <script type="text/javascript">
        var changeCode = function () {
            ...
            img.src = "${root}/checkCode?time=" + new Date().getTime();
        };
    </script>
            ...
            <div
                ...
                <form class="form-horizontal" method="post" action="login.htm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <img src="checkCode" id="img" onclick="changeCode()"/>
                        </div>
                    </div>
                    <div>
                        <h4 style="color: #ff0000;padding-left: 50px">${msg}</h4>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                ...
                                <c:if test="${cookie.isSave.value.equals('on')}">
                                    <input name="isSave" type="checkbox" checked="checked" id="cb"> 记住密码
                                </c:if>
                                <c:if test="${!cookie.isSave.value.equals('on')}">
                                    <input name="isSave" type="checkbox" id="cb"> 记住密码
                                </c:if>
                            </label>
                            </div>
                        </div>
